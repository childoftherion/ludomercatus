...
export const DraggableModal: React.FC<DraggableModalProps> = ({
  ...
  return (
    ...
    >
      <div
        style={{
          backgroundColor: restStyle.backgroundColor !== undefined ? restStyle.backgroundColor : "rgba(0, 0, 0, 0.95)",
          borderRadius: restStyle.borderRadius !== undefined ? restStyle.borderRadius : "16px",
          boxShadow: restStyle.boxShadow !== undefined ? restStyle.boxShadow : "0 8px 32px rgba(0, 0, 0, 0.5)",
          border: restStyle.border !== undefined ? restStyle.border : "1px solid rgba(255,255,255,0.1)",
          minWidth: isMinimized ? (minimizedTitle ? "120px" : "80px") : minWidth,
      ...
      >
        ...
        >
          <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.6)", userSelect: "none" }}>
            Drag to move
          </div>
