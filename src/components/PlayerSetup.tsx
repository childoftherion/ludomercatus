        ...
        {showAdvancedSettings && (
          ...
          >
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      hideOpponentWealth: e.target.checked,
                    }))
                  }
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      hideOpponentProperties: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                💡 Like real markets, you won't know competitors' exact
                financial positions!
              </p>
            </div>
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableHousingScarcity: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableInflation: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableProgressiveTax: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableBankLoans: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
                <span style={{ fontSize: '14px' }}>
                  🏦 Bank loans (
                  {Math.round(gameSettings.loanInterestRate * 100)}%
                  interest/turn)
                </span>
              </label>
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableEconomicEvents: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableRentNegotiation: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enablePropertyInsurance: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enablePropertyValueFluctuation: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
                <span style={{ fontSize: '14px' }}>
                  📈 Property value fluctuation (development affects property
                  values)
                </span>
              </label>
              ...
              >
                <input
                  ...
                  onChange={e =>
                    setGameSettings(s => ({
                      ...s,
                      enableBankruptcyRestructuring: e.target.checked,
                    }))
                  }
                  style={{ width: '18px', height: '18px' }}
                />
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <h3 style={{ marginBottom: '12px', color: '#2E8B57' }}>
              Your Player
            </h3>
          ...
          >
            <h3 style={{ marginBottom: '12px', color: '#E65100' }}>
              AI Opponents
            </h3>
                        ...
                        {TOKENS.map(token => {
                          ...
                          return (
                            <motion.button
                              key={token}
                              onClick={() =>
                                !isDisabled && handleAiTokenSelect(index, token)
                              }
          ...
          <motion.button
            ...
            whileHover={{
              scale: playerToken && aiTokens.every(t => t) ? 1.05 : 1,
            }}
            whileTap={{
              scale: playerToken && aiTokens.every(t => t) ? 0.95 : 1,
            }}
            style={{
              padding: '16px 48px',
              fontSize: '20px',
              fontWeight: 'bold',
              backgroundColor:
                playerToken && aiTokens.every(t => t) ? '#2E8B57' : '#ccc',
              color: '#fff',
              border: 'none',
              borderRadius: '8px',
              cursor:
                playerToken && aiTokens.every(t => t)
                  ? 'pointer'
                  : 'not-allowed',
              boxShadow: '0 4px 12px rgba(46, 139, 87, 0.4)',
            }}
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <h3 style={{ marginBottom: '12px', color: '#4169E1' }}>
              Human Players
            </h3>
                ...
                >
                  <div style={{ marginBottom: '8px' }}>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleHumanNameChange(index, e.target.value)
                      }
                      style={{
                        width: '100%',
                        padding: '6px',
                  ...
                  <div>
                    ...
                    >
                      {getMultiplayerAvailableTokens('human', index).map(
                        token => (
                          <button
                            key={token}
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {getMultiplayerAvailableTokens('ai', index).map(
                          token => (
                            <button
                              key={token}
                              onClick={() =>
                                handleMpAiTokenSelect(index, token)
                              }
                              style={{
                                fontSize: '20px',
                                padding: '6px',
          ...
          <motion.button
            ...
            style={{
              ...
              borderRadius: '8px',
              cursor:
                humanTokens.some(t => !t) || mpAiTokens.some(t => !t)
                  ? 'not-allowed'
                  : 'pointer',
              boxShadow: '0 4px 12px rgba(65, 105, 225, 0.4)',
              opacity:
                humanTokens.some(t => !t) || mpAiTokens.some(t => !t) ? 0.5 : 1,
            }}
          >
