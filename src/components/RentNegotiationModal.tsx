...
export const RentNegotiationModal: React.FC = () => {
  ...
  const handleOfferPaymentPlan = () => {
    ...
    useGameStore
      .getState()
      .offerPaymentPlan(Math.floor(partialPayment), iouInterestRate)
  }
  ...
  return (
    <AnimatePresence>
      <motion.div
        role="dialog"
        aria-label={`Rent negotiation: ${debtor.name} owes ${creditor.name}`}
        ref={modalRef}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span>
                    {(proposedIOU.interestRate * 100).toFixed(0)}% / turn
                  </span>
                </div>
                <div
                  style={{
