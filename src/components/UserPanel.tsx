...
export const UserPanel: React.FC<UserPanelProps> = ({ myPlayerIndex }) => {
  ...
  const [activeTab, setActiveTab] = useState<'properties' | 'financials'>(
    'properties',
  )
      ...
      {players.map((player, index) => {
        ...
        return (
          ...
          >
            <div
              onMouseEnter={
                isMobile ? undefined : () => setExpandedPlayerIndex(index)
              }
              onMouseLeave={
                isMobile ? undefined : () => setExpandedPlayerIndex(null)
              }
              onClick={() => {
                if (isMobile) {
                              ...
                              <div style={{ padding: '10px', color: '#fff' }}>
                                    ...
                                    >
                                      {player.bankLoans.map(loan => (
                                        ...
                                        >
                                          ...
                                          >
                                            Taken on Turn {loan.turnTaken} |
                                            Rate:{' '}
                                            {(loan.interestRate * 100).toFixed(
                                              0,
                                            )}
                                            %
                                          </div>
                                  ...
                                  player.iousPayable.length > 0 ? (
                                    ...
                                    >
                                      {player.iousPayable.map(iou => {
                                        const creditor = players.find(
                                          p => p.id === iou.creditorId,
                                        )
                                        return (
                                          <div
                                            key={iou.id}
                                          ...
                                          >
                                            ...
                                            >
                                              Original: £
                                              {(
                                                iou.originalAmount || 0
                                              ).toLocaleString()}{' '}
                                              | Rate:{' '}
                                              {(iou.interestRate * 100).toFixed(
                                                0,
                                              )}
                                              %
                                            </div>
                                ...
                                {player.inChapter11 && (
                                  ...
                                  >
                                    ...
                                    >
                                      Debt Target: £
                                      {player.chapter11DebtTarget.toLocaleString()}
                                    </div>
                                    <div
                                      style={{
                                        fontSize: '10px',
