...
export interface Player {
  ...
  tradeHistory: Record<
    string,
    { attempts: number; lastOffer: number; lastOfferTurn?: number }
  > | null // Key: "playerId-propertyId" or "playerId-set:propIds"
  ...
  chapter11CreditorIndex?: number // Creditor to receive assets if Chapter 11 fails
...
export const DEFAULT_GAME_SETTINGS: GameSettings = {
  ...
  loanInterestRate: 0.1, // 10% interest per turn
  maxLoanPercent: 0.5, // Can borrow up to 50% of net worth
